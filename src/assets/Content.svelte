<div class="relative overflow-hidden bg-dark">
     <div class="max-w-7xl mx-auto pt-48 md:pt-72 lg:pt-64 px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
            <!-- retail card -->
            <div class="bg-white/10 rounded-lg p-6 shadow-lg border border-white/10 hover:border-orange-500 transition-all duration-300">
                <h2 class="text-light text-2xl md:text-3xl mb-4">Retail</h2>
                <div class="h-0.5 w-16 bg-orangen mb-6 rounded-full"></div>

                <div class="bg-gray-900 p-4 rounded-md mb-5 border-l-4 border-orange-500">
                    <p class="text-gray-300 b-2">"Where should I place my next store to maximize foot traffic while minimizing competition?"</p>
                </div>
            ...
            <!-- real estate card -->
            <div class="bg-white/10 rounded-lg p-6 shadow-lg border border-white/10 hover:border-orange-500 transition-all duration-300">
                <h2 class="text-light text-2xl md:text-3xl mb-4">Real Estate</h2>
                <div class="h-0.5 w-16 bg-orangen mb-6 rounded-full"></div>

                <div class="bg-gray-900 p-4 rounded-md mb-5 border-l-4 border-orange-500">
                    <p class="text-gray-300 b-2">"Identify properties within 2 miles of downtown with high growth potential based on infrastructure plans."</p>
                </div>

                <div class="bg-gray-900 p-4 rounded-md border-l-4 border-pink-500">
                    <p class="text-gray-300 mb-2">"Which areas show rising property values correlated with improved accessibility to amenities?"</p>
                </div>
            </div>
        </div>
     </div>
